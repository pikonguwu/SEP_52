...
public class InvestmentsView extends BaseView {
    ...
    protected void initUI() {
        ...
        // 创建带边框的图表板块
        chartPanel.add(createChartSection(createAnnualChart("Yearly Income", true), "Yearly Income Trend"));
        chartPanel.add(createChartSection(createAnnualChart("Yearly Expense", false), "Yearly Expense Trend"));
        chartPanel.add(createChartSection(createMonthlyChart("Monthly Income"), "Monthly Income Trend"));
        chartPanel.add(createChartSection(createMonthlyChart("Monthly Expense"), "Monthly Expense Trend"));
    ...
    private JPanel createAnalysisPanel() {
        ...
        // 添加按钮点击事件
        reportButton.addActionListener(e -> analysisService.generateInvestmentReport(this));
